...
class Autocomplete(object):
    ...
    def generate_proposals(self):
        self.commands = {
            ...
            'begin{verbatim}': {'command': 'begin{verbatim}', 'description': 'Verbatim environment, content won\'t be interpreted as LaTeX.'},
            ...
            'verb': {'command': 'verb|•|', 'description': 'Inline verbatim text that won\'t be interpreted as LaTeX.'},
