...
class BibTeXWizard(Dialog):
    ...
    def __init__(self, main_window, workspace):
        ...
        self.document_types['software'] = {'title': _('Software'), 'description': _('Computer software. The standard styles will treat this entry type as an alias for @misc.'), 'fields_required': ['author/editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'language', 'howpublished', 'type', 'version', 'note', 'organization', 'location', 'month', 'year', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
