...
class AutocompleteProvider(object):
    ...
    def get_commands(self):
        commands = dict()
        for filename in ['latex-document.xml', 'tex.xml', 'textcomp.xml', 'graphicx.xml', 'latex-dev.xml', 'amsmath.xml', 'amsopn.xml', 'amsbsy.xml', 'amsfonts.xml', 'amssymb.xml', 'amsthm.xml', 'color.xml', 'geometry.xml']:
