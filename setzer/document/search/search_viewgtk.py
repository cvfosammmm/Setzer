...
class SearchBar(Gtk.Revealer):
    ...
    def __init__(self):
        ...
        self.replace_button = Gtk.Button.new_with_label('Replace')
        self.replace_button.set_can_focus(False)
        self.replace_button.set_tooltip_text('Replace selected result')
        self.replace_button.set_sensitive(False)
        self.replace_all_button = Gtk.Button.new_with_label('All')
        self.replace_all_button.set_can_focus(False)
        self.replace_all_button.set_tooltip_text('Replace all results')
