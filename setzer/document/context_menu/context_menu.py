...
class ContextMenu(object):
    ...
    def build_popover(self, popover):
        ...
        self.current_popover.add_widget(button_undo)
        button_redo = self.create_button(_('Redo'), 'win.redo', shortcut=_('Shift') + '+' + _('Ctrl') + '+Z')
        self.current_popover.add_widget(button_redo)
        ...
        if self.document.is_latex_document():
            ...
            self.current_popover.add_widget(button_toggle_comment)
            button_forward_sync = self.create_button(_('Show in Preview'), 'win.forward-sync')
            self.current_popover.add_widget(button_forward_sync)
            self.current_popover.add_widget(Gtk.Separator.new(Gtk.Orientation.HORIZONTAL))
        ...
        self.current_popover.add_widget(box)
