...
class ModeDefault(object):
    ...
    def insert_begin_end_replace(self, start_iter_begin, insert_iter, replace_previous_command_data):
        ...
        self.document.content.source_buffer.begin_user_action()
        ...
        if end_match_object != None:
            start_iter_begin = self.document.content.source_buffer.get_iter_at_offset(end_iter_offset)
            ...
            self.document.content.replace_range_no_user_action(start_iter_end, end_iter_end, end_command, indent_lines=False, select_dot=False)

        self.document.content.source_buffer.end_user_action()
