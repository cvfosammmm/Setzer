...
class HeaderBar(Gtk.HeaderBar):
    ...
    def insert_workspace_menu(self):
        ...
        self.pmb.add_header_button(self.session_box, 'Session')
        ...
        self.pmb.add_action_button(self.session_box, 'Restore Previous Session...', 'win.restore-session', [''])
        self.pmb.add_action_button(self.session_box, 'Save Current Session...', 'win.save-session')
