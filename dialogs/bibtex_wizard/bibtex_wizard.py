...
class BibTeXWizard(Dialog):
    ...
    def __init__(self, main_window, workspace, settings):
        ...
        self.document_types['mvbook'] = {'title': 'Multi-volume Book', 'description': 'A multi-volume @book. For backwards compatibility, multi-volume books are also supported by the entry type @book. However, it is advisable to make use of the dedicated entry type @mvbook.', 'fields_required': ['author', 'title', 'date'], 'fields_optional': ['editor', 'editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'language', 'origlanguage', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['inbook'] = {'title': 'Part of a Book With Its Own Title', 'description': 'A part of a book which forms a self-contained unit with its own title. Note that the profile of this entry type is different from standard BibTeX.', 'fields_required': ['author', 'title', 'booktitle', 'date'], 'fields_optional': ['bookauthor', 'editor', 'editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'maintitle', 'mainsubtitle', 'maintitleaddon', 'booksubtitle', 'booktitleaddon', 'language', 'origlanguage', 'volume', 'part', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'chapter', 'pages', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        ...
        self.document_types['collection'] = {'title': 'Single-volume Collection', 'description': 'A single-volume collection with multiple, self-contained contributions by distinct authors which have their own title. The work as a whole has no overall author but it will usually have an editor.', 'fields_required': ['editor', 'title', 'date'], 'fields_optional': ['editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'maintitle', 'mainsubtitle', 'maintitleaddon', 'language', 'origlanguage', 'volume', 'part', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'chapter', 'pages', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['mvcollection'] = {'title': 'Multi-volume Collection', 'description': 'A multi-volume @collection. For backwards compatibility, multi-volume collections are also supported by the entry type @collection. However, it is advisable to make use of the dedicated entry type @mvcollection.', 'fields_required': ['editor', 'title', 'date'], 'fields_optional': ['editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'language', 'origlanguage', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['incollection'] = {'title': 'Article in a Collection', 'description': 'A contribution to a collection which forms a self-contained unit with a distinct author and title. The <tt>author</tt> refers to the <tt>title</tt>, the <tt>editor</tt> to the <tt>booktitle</tt>, i. e., the title of the collection.', 'fields_required': ['author', 'editor', 'title', 'booktitle', 'date'], 'fields_optional': ['editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'maintitle', 'mainsubtitle', 'maintitleaddon', 'booksubtitle', 'booktitleaddon', 'language', 'origlanguage', 'volume', 'part', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'chapter', 'pages', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        ...
        self.document_types['dataset'] = {'title': 'Data Set', 'description': 'A data set or a similar collection of (mostly) raw data.', 'fields_required': ['author/editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'language', 'edition', 'type', 'series', 'number', 'version', 'note', 'organization', 'publisher', 'location', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['manual'] = {'title': 'Technical Manual', 'description': 'Technical or other documentation, not necessarily in printed form. The <tt>author</tt> or <tt>editor</tt> is omissible.', 'fields_required': ['author/editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'language', 'edition', 'type', 'series', 'number', 'version', 'note', 'organization', 'publisher', 'location', 'isbn', 'chapter', 'pages', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['misc'] = {'title': 'Miscellaneous', 'description': 'A fallback type for entries which do not fit into any other category. Use the field <tt>howpublished</tt> to supply publishing information in free format, if applicable. The field type may be useful as well. <tt>author</tt>, <tt>editor</tt>, and <tt>year</tt> are omissible.', 'fields_required': ['author/editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'language', 'howpublished', 'type', 'version', 'note', 'organization', 'location', 'date', 'month', 'year', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        ...
        self.document_types['proceedings'] = {'title': 'Conference Proceedings', 'description': 'A single-volume conference proceedings. This type is very similar to @collection. It supports an optional <tt>organization</tt> field which holds the sponsoring institution. The <tt>editor</tt> is omissible.', 'fields_required': ['editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'maintitle', 'mainsubtitle', 'maintitleaddon', 'eventtitle', 'eventdate', 'venue', 'language', 'volume', 'part', 'volumes', 'series', 'number', 'note', 'organization', 'publisher', 'location', 'month', 'isbn', 'chapter', 'pages', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['mvproceedings'] = {'title': 'Multi-volume Proceedings Entry', 'description': 'A multi-volume @proceedings entry. For backwards compatibility, multi-volume proceedings are also supported by the entry type @proceedings. However, it is advisable to make use of the dedicated entry type @mvproceedings.', 'fields_required': ['editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'eventtitle', 'eventdate', 'venue', 'language', 'volumes', 'series', 'number', 'note', 'organization', 'publisher', 'location', 'month', 'isbn', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        ...
        self.document_types['mvreference'] = {'title': 'Multi-volume Reference Entry', 'description': 'A multi-volume @reference entry. The standard styles will treat this entry type as an alias for @mvcollection. For backwards compatibility, multi-volume references are also supported by the entry type @reference. However, it is advisable to make use of the dedicated entry type @mvreference.', 'fields_required': ['editor', 'title', 'date'], 'fields_optional': ['editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'language', 'origlanguage', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'pagetotal', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        self.document_types['inreference'] = {'title': 'Article in a Reference', 'description': 'An article in a work of reference. This is a more specific variant of the generic @incollection entry type. The standard styles will treat this entry type as an alias for @incollection.', 'fields_required': ['author', 'editor', 'title', 'booktitle', 'date'], 'fields_optional': ['editora', 'editorb', 'editorc', 'translator', 'annotator', 'commentator', 'introduction', 'foreword', 'afterword', 'subtitle', 'titleaddon', 'maintitle', 'mainsubtitle', 'maintitleaddon', 'booksubtitle', 'booktitleaddon', 'language', 'origlanguage', 'volume', 'part', 'edition', 'volumes', 'series', 'number', 'note', 'publisher', 'location', 'isbn', 'chapter', 'pages', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
        ...
        self.document_types['software'] = {'title': 'Software', 'description': 'Computer software. The standard styles will treat this entry type as an alias for @misc.', 'fields_required': ['author/editor', 'title', 'date'], 'fields_optional': ['subtitle', 'titleaddon', 'language', 'howpublished', 'type', 'version', 'note', 'organization', 'location', 'date', 'month', 'year', 'addendum', 'pubstate', 'doi', 'eprint', 'eprintclass', 'eprinttype', 'url', 'urldate']}
