...
class MainApplicationController(Gtk.Application):
    ...
    *** app menu
    ...
    def on_appmenu_show_about_dialog(self, action, parameter=''):
        ...
        self.about_dialog.set_copyright('Copyright © 2018 - the Setzer developers')
        self.about_dialog.set_comments('Setzer is a LaTeX editor.')
        self.about_dialog.set_license_type(Gtk.License.GPL_3_0)
        self.about_dialog.set_website('https://gitlab.gnome.org/cvfosammmm/setzer')
        self.about_dialog.set_website_label('https://gitlab.gnome.org/cvfosammmm/setzer')
